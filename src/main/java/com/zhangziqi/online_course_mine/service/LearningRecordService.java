...
public interface LearningRecordService {
     ...
     * @return 学习热力图数据
     */
    LearningHeatmapVO getUserLearningHeatmap(Long userId, LocalDate startDate, LocalDate endDate);
     ...
     * @param startDate 开始日期
     * @param endDate 结束日期
     * @return 按日期分组的学习热力图数据
     */
    DateLearningHeatmapVO getUserLearningHeatmapByDate(Long userId, LocalDate startDate, LocalDate endDate);
}