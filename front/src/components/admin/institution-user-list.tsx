...
export function InstitutionUserList({ institutionId, institutionName }: InstitutionUserListProps) {
  ...
  useEffect(() => {
    fetchUsers();
  }, [institutionId, currentPage, pageSize]);
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-medium">{institutionName} 的用户</h3>
