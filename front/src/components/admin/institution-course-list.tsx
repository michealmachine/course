...
interface InstitutionCourseListProps {
  institutionId: number;
  institutionName: string;
}

export function InstitutionCourseList({ institutionId, institutionName }: InstitutionCourseListProps) {
  ...
  useEffect(() => {
    fetchCourses();
  }, [institutionId, currentPage, pageSize, showWorkspace]);
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-medium">{institutionName} 的课程</h3>
